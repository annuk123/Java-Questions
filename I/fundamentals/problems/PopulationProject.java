public class PopulationProject {
    ...
    public static void main(String[] args) {
        ...
        // population changes in five years
        System.out.println("Birth Population is the next 5 years will be: " + births_in_five_year);
        System.out.println("Deaths Population in the next 5 years will be: " + deaths_in_five_year);
        System.out.println("Immigrants population in the next 5 years will be: " + immigrants_in_five_year);

        // total population in a year and next 5 years
        System.out.println("\nIn one Year Population is Projected to be: " + net_population_change_per_year);
        System.err.println("Total Population in the next 5 Years will be: " + net_population_change_in_next_five_years);
    }
}